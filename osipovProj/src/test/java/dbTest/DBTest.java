...
//        logger.info("Size = " + dataFromSeleniumTable.size());
        int numberOfRows = mysqlDB.changeTable("INSERT INTO seleniumTable VALUES('098', '%s', '%s')", login, "12345");
        ...
        logger.info(dbUtilSeleniumTable.getPassForLogin("G7-osipov"));
    }
}
