...
public class CurrencyDto {
    ...
    public CurrencyDto() { // пустий конструктор
    }

    public CurrencyDto(String date, String bank, Integer baseCurrency, String baseCurrencyLit, ExchangeRateDto[] exchangeRate) {
        this.date = date;
        this.bank = bank;
