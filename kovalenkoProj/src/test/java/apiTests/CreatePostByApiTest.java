...
public class CreatePostByApiTest {
    ...
    public void createPostByApiTest() {
        ...
        PostDto[] actualPostDtoByUser = apiHelper.getAllPostsByUser();
        Assert.assertEquals("Number of posts ", 1, actualPostDtoByUser.length);
        ...
        softAssertions.assertThat(actualPostDtoByUser).usingRecursiveComparison()
                .ignoringFields("id", "createdDate", "author.avatar").isEqualTo(expectedPostsDTO);
