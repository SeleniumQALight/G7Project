...
public class LoginTest {
    ...
    public void invalidLoginIn() {
        ...
        Assert.assertTrue("'Invalid username/password.' message is not displayed", isButtonInvalid_username_passwordVisible());
    ...
    private boolean isButtonInvalid_username_passwordVisible() {
        try {
