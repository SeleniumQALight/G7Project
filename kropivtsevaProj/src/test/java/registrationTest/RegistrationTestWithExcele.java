...
public class RegistrationTestWithExcele extends BaseTest {
    String userName;
    String email;
    String password;
    String expectedMessages;

    public RegistrationTestWithExcele(String userName, String email, String password, String expectedMessages) {
