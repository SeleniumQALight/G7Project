...
//        String login1 = "newqaauto";
//        ArrayList<Map<String,String>> dataFromSeleniumTable1 = // створюємо мапку для витягування даних з БД
//                mysqlDB.selectTableAsMap(   // витягуємо дані з БД
//                        String.format("SELECT * FROM seleniumUsers WHERE login = '%s'", login1)); //
...
//        DB_Util_seleniumUsers db_util_seleniumUS = new DB_Util_seleniumUsers();//достаємо пароль за логіном
//        logger.info(db_util_seleniumUS.getPassForLogin("newqaauto"));
    }
}
