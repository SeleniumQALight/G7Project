...
//                    .isEqualToIgnoringGivenFields(expectedPostDto[i].getAuthor(), "avatar");
    ...
    @Test
    public void getAllPostsBytUserNegative() {
        String actualResponse =
                given()
                        .contentType(ContentType.JSON)//додали хедер аплікейшина
                        .log().all()//виводимо в колсоль весь запит
                        .when()// дія
                        .get(EndPoints.GET_POSTS_BY_USER, "notValidUser")
                        .then()
                        .statusCode(200)
                        .log().all()
    ...
    public void getAllPostsByUserPath() {
        ...
        List<String> actualTitleList = response.jsonPath()
        ...
        List<Map> actualAuthorList = response.jsonPath()
